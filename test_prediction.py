...
model = tf.keras.models.load_model("D:/Source/myCode/models/product_recognition_model_v4_128x05.h5")

# Список классов ДОЛЖЕН СООТВЕТСТВОВАТЬ обучению (проверьте train_data.class_indices)
